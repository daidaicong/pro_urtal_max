...
//轮子到轮子的距离是54cm
#define MOTOR_DISTANCE_TO_CENTER 0.27
...
// 0.18NM/A
#define M2006_TOR_TO_CAN_DATA 	5555.5555
//电机码盘值最大以及中值
...
#define M2006_MOTOR_RPM_TO_VECTOR  0.0061261005f   //2pi/60  * R(0.117/2)
#define WHEEL_R 0.0925
...
// 腿部初始长度
#define LEG_LENGTH_INIT 0.15f
// 腿部离地时便于缓冲需要的长度
#define LEG_LENGTH_BUFFER 0.18f
...
// 腿部长度控制PID
#define LEG_LENGTH_PID_KP 700.0f
...
#define ROLL_CTRL_L_PID_KP 0.3f
#define ROLL_CTRL_L_PID_KI 0.00f
#define ROLL_CTRL_L_PID_KD 0.05f
...
typedef struct
{
	...
	fp32 tmp;	//随便幅值，用来在usertask看数值
	fp32 fuck;

	fp32 left_leg_real_support;
	fp32 right_leg_real_support;
